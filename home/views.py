...
symp=['dizziness','back_pain','constipation','abdominal_pain','diarrhoea','mild_fever','yellow_urine',
...
def pharmacysearch(request):
    ...
    if query != '':
        ...
        if (object_list):
            return render(request,'pharmacysearch.html',{'objectlist':object_list,'found':True,'location':query})
        else:   
