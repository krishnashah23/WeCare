...
from .views import index,doctorhome,adminhome,news,getprofile,pharmacysearch, updateprofile,gotosearch,search,hospitalsearch,viewdoctorprofiles,pharmacysearchnearest,hospitalsearchnearest
